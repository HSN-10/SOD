...
<div class="container text-center" style="top:0; position:absolute; width:100%;">
    <div class="row">
        <div class="col p-4 bg-warning"><i class="fas fa-car fa-2x text-white"></i> <h2 class="d-inline text-white pl-4">{{$total['Driver']}}</h2></div>
        <div class="col p-4 bg-secondary"><i class="fas fa-shopping-cart fa-2x text-white"></i><h2 class="d-inline text-white pl-4">{{$total['Shop']}}</h2></div>
    </div>
    <div class="row">
        <div class="col p-2 text-center bg-info"><i class="fas fa-equals fa-2x text-white d-inline"></i><h2 class="d-inline text-white pl-4">{{$total['all']}}</h2></div>
    </div>
</div>
